...
// Функция для создания SVG-карты (фронтальная сторона)
const createCardFront = () => {
    return svg(
        ...
        svg("g", {id: "Front"},
            ...
            svg("g", [
                svg("text.st2.st5.st9", {transform: "matrix(1 0 0 1 574.4219 433.8095)", id: "svgexpire"},"01/23"),
                ...
                svg("polygon", {points: "554.5,421 540.4,414.2 540.4,427.9 		",
                    class: "st2"})
                ]
            ),
            svg("g", {id: "cchip"}, [
...
// Функция для создания SVG-карты (задняя сторона)
        ...
        "svg", {version:"1.1", id:"cardback", xmlns:"http://www.w3.org/2000/svg",
            ...
            [
                ...
                svg("g", {id: "Back"}, [
                    svg("g", {id: "Page-1_2_"},
                        svg("g", {id: "amex_2_"},
                            svg("path.darkcolor", {id:"Rectangle-1_2_", class:"greydark", d:"M40,0h670c22.1,0,40,17.9,40,40v391c0,22.1-17.9,40-40,40H40c-22.1,0-40-17.9-40-40V40C0,17.9,17.9,0,40,0z"})
                        )
                    ),
...
const createForm = () => {
    return el('div.form-container', [
        el('div.field-container', [
            ...
            el('input', { id: "name", type: "text", maxlength: "20" })
        ]),
        el('div.field-container', [
            el('label', { for: "cardnumber" }, "Card Number"),
            el('input', { id: "cardnumber", type: "text", pattern: "[0-9]*", inputmode: "numeric" }),
            svg("svg.ccicon", {version:"1.1", id:"ccicon", xmlns:"http://www.w3.org/2000/svg",
            xmlns: {xlink: "http://www.w3.org/1999/xlink"}, width:"750", height:"471",
            viewBox:"0 0 750 471"},
...
const containerCard = el('div.container', [
    el('div.creditcard', [
        el('div.front', [el('div#ccsingle'), createCardFront()]),
        el('div.back', createCardBack())
    ])
]);
...
setChildren(document.body, [title, containerCard, containerForm]);